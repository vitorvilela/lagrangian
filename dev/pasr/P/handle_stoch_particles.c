...
void PARTICLES_MAP(notionalParticle_t *, const double [], volume_t **, double);
...
//   gets(in);  
     ...
     PARTICLES_MAP(notionalParticleArray, A, ptr_last, stime);
...
void PARTICLES_MAP(notionalParticle_t *notionalParticleArray, const double A[], volume_t **ptr_last, double stime) {
