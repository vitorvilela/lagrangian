...
//       gets(in);
	...
	//Percorre partículas nos volumes do tempo anterior, antes da alteração dos ids na HT, como necessário - movimento e mistura paralelamente realizados
