...
void INITIALIZE_PTS_MAP(notionalParticle_t *, const double []);
...
//   const double A[9] = {a1, a2, b1, b2, c1, c2, dx, dy, dz};
  ...
  const int B[25] = {levels, 0, 1, 1, 1, 4, 4, 1, 1, 1, 3, 3, 1, 4, 4, 1, 17, 2, 7, 7, 1, 4, 4, 1, 33};
  const double A[15] = {a1, a2, b1, b2, c1, c2, 0.25, 0.125, 0.0625, 0.25, 0.125, 0.0625, 0.25, 0.125, 0.0625};
  ...
  INITIALIZE_PTS_MAP(notionalParticleArray, A);
...
void INITIALIZE_PTS_MAP(notionalParticle_t *notionalParticleArray, const double A[]) {
